        ...
        <header className='header-container'>
            < div className='custom-header'>
                ...
                <div className='socials'>
                    <Link className='link-dom' target='blank' to="https://www.linkedin.com/in/clara-maestri-681352210/">
                        <LinkedinLogo className='icon' size={20} weight="fill" />
                    </Link>
                    <Link className='link-dom' target='blank' to="https://github.com/vivalaclara">
